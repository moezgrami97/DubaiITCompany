    ...
    <>
      <div className="blog-area pt-100 pb-70">
          ...
          <div className="row justify-content-center">
              ...
              <div className="single-blog-post bg-fffbf5">
                <div className="post-image">
                  <Link href="/blog/details">
                    <Image src="/img/blog/blog-img4.jpg" alt="image" width={750} height={650} />
                  </Link>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-blog-post bg-fffbf5">
                <div className="post-image">
                  <Link href="/blog/details">
                    <Image src="/img/blog/blog-img5.jpg" alt="image" width={750} height={650} />
                  </Link>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-blog-post bg-fffbf5">
                <div className="post-image">
                  <Link href="/blog/details">
                    <Image src="/img/blog/blog-img6.jpg" alt="image" width={750} height={650} />
                  </Link>
                </div>
        ...
        <div className="vector-shape1">
          <Image src="/img/shape/vector-shape1.png" alt="image" width={594} height={580} />
        </div>
        <div className="vector-shape2">
          <Image src="/img/shape/vector-shape2.png" alt="image" width={594} height={580} />
        </div>
      </div>
    </>
  );
