...
import CaseStudiesImageSlider from "./CaseStudiesImageSlider";
import Image from "next/image";

const CaseStudiesDetailsContentTwo: React.FC = () => {
  return (
    <>
...
export default CaseStudiesDetailsContentTwo;
