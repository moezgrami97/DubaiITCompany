            ...
            <div className="col-lg-5 col-md-12">
              <div className="hero-banner-content">
                <h1
                  ...
                  data-aos-delay="100"
                >
                  Our Approach: Agile, Scrum-based Excellence
                </h1>
                ...
                <p
                  ...
                  data-aos-delay="200"
                >
                  At AlberoIT, we believe in the power of collaboration, transparency, and continuous improvement. Our approach to every project is rooted in the Scrum methodology, an agile framework that ensures flexibility, accountability, and results. By adopting Scrum, we ensure that our teams are always aligned with your business objectives, making it possible to adapt quickly to changing market demands and customer feedback.
                </p>
